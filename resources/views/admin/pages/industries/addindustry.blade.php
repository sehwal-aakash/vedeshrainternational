        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="card-title mb-0">Add Industry</h5>
                    <a href="/nimdav/pages/industries/listindustries"><span class="btn btn rounded-pill btn-primary-100 text-primary-600 radius-8 px-24 py-4">Back</span></a>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.industries.add.post') }}" method="POST">
                    @csrf
                    <div class="row gy-3">
                                <div class="col-12">
