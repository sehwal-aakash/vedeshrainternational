                    ...
                    <form action="{{ route('admin.blogs.add.post') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row gy-3">
                            ...
                            <div class="col-6">
                                ...
                                <input type="date" name="published_at" class="form-control datepicker" id="published_at">
                            </div>
                            ...
                            <div class="col-6">
                                ...
                                <input type="number" name="views_count" class="form-control" id="views_count" value="0">
                            </div>
