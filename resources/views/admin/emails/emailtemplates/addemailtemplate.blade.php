        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="card-title mb-0">Add Email Templates</h5>
                ...
                <div class="card-body">
                    <form action="{{ route('admin.emailtemplates.add.post') }}" method="POST">
                        @csrf
                        <div class="row gy-3">
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="required_variables" class="form-control" id="required_variables" rows="3"></textarea>
                            </div>
                            <div class="col-12">
