...
@section('title') Get a Quote | Vedeshra Technologies: Custom Web & Marketing Solutions @endsection

@section('meta')
<meta name="title" content="Get a Quote | Vedeshra Technologies: Custom Web & Marketing Solutions">
<meta name="description" content="Looking for expert web design or digital marketing? Get a customized quote from Vedeshra Technologies today and start growing your business.">
<meta name="keywords" content="Web Design Quote, Digital Marketing Quote, Custom Website Pricing, SEO Services Cost, Branding Solutions, Vedeshra Technologies">
...
<meta property="og:description" content="Need professional web design or marketing? Request a free quote from Vedeshra Technologies and get tailored solutions for your business success.">
<meta property="og:type" content="website">

<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:title" content="Get a Custom Quote | Vedeshra Technologies">
<meta name="twitter:description" content="Grow your business with expert web design & marketing services. Get a free quote from Vedeshra Technologies today!">
                                ...
                                <div class="formflexbox">
                                    ...
                                    <div class="formflexitembox box-50">
                                        <select
                                            name="selectregion"
                                            id="selectregion"
                                            class="forminputfield @error('selectregion') is-invalid @enderror"
                                            required
                                        >
                                            <option value="">Select Region</option>
                                            <option value="north-america" {{ old('selectregion') == 'north-america' ? 'selected' : '' }}>North America</option>
                                            <option value="south-america" {{ old('selectregion') == 'south-america' ? 'selected' : '' }}>South America</option>
                                            <option value="europe" {{ old('selectregion') == 'europe' ? 'selected' : '' }}>Europe</option>
                                            <option value="south-africa" {{ old('selectregion') == 'south-africa' ? 'selected' : '' }}>South Africa</option>
                                            <option value="asia" {{ old('selectregion') == 'asia' ? 'selected' : '' }}>Asia</option>
                                            <option value="australia" {{ old('selectregion') == 'australia' ? 'selected' : '' }}>Australia</option>
                                        </select>
                                        @error('selectregion')
                                            <div class="error">{{ $message }}</div>
                                        @enderror
