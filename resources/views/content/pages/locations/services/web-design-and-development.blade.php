    ...
    <section class="inner-services-grid-section section">
        <div class="container">
            <div class="sectiontitlebox">
                <h2>Comprehensive Web Solutions for {{ location }}</h2>
                <p>Vedeshra Technologies delivers a full spectrum of web design and development services across
                    {{ location }}. From captivating UI/UX to robust eCommerce and custom platforms, we make sure
                    your site is built for success.</p>
            </div>
            <div class="inner-services-grid-box">
                <div class="inner-services-grid-item-box">
                    <div class="inner-services-grid-item">
                ...
                <div class="inner-services-grid-item-box">
                    <div class="inner-services-grid-item">
                        ...
                        <div class="inner-services-grid-content-box">
                            <h3>Website Redesign & Maintenance</h3>
                            <p>Transform your outdated site for {{ location }} markets, with fresh designs and
                                ongoing security/performance updates.</p>
                        </div>
                    </div>
                </div>
                <div class="inner-services-grid-item-box">
                    ...
                    <div class="platform-grid-item">
                        ...
                        <div class="platformgridcontentbox">
                            ...
                            <div class="platformgridcontent">
                                ...
                                <p>
                                    SEO-friendly, fast, and easy to update—ideal for {{ location }} businesses
                                    seeking advanced performance.
                                </p>
                            </div>
                        </div>
                    </div>
