...
@section('content')
        ...
        <div class="container">
            <div class="imagewithtextflexbox">
                <div class="imagewithtextfleximagebox">
                    <img src="https://vedeshra.com/assets/img/vectorimages/video-production-img-01.png" loading="lazy" alt="Video Marketing Vector Image">
                </div>
    ...
    <section class="imagewithtextsection section">
        <div class="container">
            <div class="imagewithtextflexbox">
                ...
                <div class="imagewithtextfleximagebox">
                    <img src="https://vedeshra.com/assets/img/vectorimages/video-production-img-02.png" loading="lazy" alt="Video Marketing Vector Image">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="imagewithtextsection section reversed" style="background-color: #f9f9f9;">
        <div class="container">
            <div class="imagewithtextflexbox">
                <div class="imagewithtextfleximagebox">
                    <img src="https://vedeshra.com/assets/img/vectorimages/video-production-img-03.png" loading="lazy" alt="Video Marketing Vector Image">
                </div>
                <div class="imagewithtextcontentbox">
